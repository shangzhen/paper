...
<form id="pagerForm" method="post"	action="/paper/stu/consultation_findAllOut">
...
<div id="main">
	<c:if test="${empty list }">
		<div
			style="text-align: center; font-size: 16px; height: 435px; line-height: 435px; color: red">管理人员还没有回复任何信息，请耐心等待</div>
	</c:if>
