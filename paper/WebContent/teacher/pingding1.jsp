	...
	<form method="post" action="user_add1" class="pageForm" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="58">
			...
			<!-- <div class="unit">
				...
				<input type="text" size="20" name="score.certNo"/>
			</div> -->
			...
			<div class="unit">
				...
				<input type="text" size="20" name="score.fcommentReportScore" id="text1"  onkeyup="check(this)" />
				
			</div>
			<div class="unit">
				<label>调查研究.整理资料(10分)：</label>
				<input type="text" size="20" name="score.fcommentVarcharScore" id="text2" onkeyup="check1(this)" />
				
			</div>
			<div class="unit">
				<label>学习态度.规范要求(10分)：</label>
				<input type="text" size="20" name="score.fcommentAttitude" id="text3" onkeyup="check1(this)" />
				
			</div>
			<div class="unit">
				<label>数据处理.文字表达(10分)：</label>
				<input type="text" size="20" name="score.fcommentShowScore" id="text4" onkeyup="check1(this)" />
				
			</div>
			<div class="unit">
				<label>论文质量.创新意识(55分)：</label>
				<input type="text" size="20" name="score.fcommentQualityScore" id="text5" onkeyup="check2(this)" />
				
			</div>
			<div class="unit">
				<label>合计(100分)：</label>
				<input disabled="true" size="20" name="sum" id="sum"/>&nbsp;
			...
			%>
			<input type="hidden" name="score.fcommentTime" value=<%=time %> />
