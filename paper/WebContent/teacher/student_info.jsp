...
<body>
<form id="pagerForm" method="post" action="/paper/teacher/teacher_findSProperty">
	<input type="hidden" name="status" value="${param.status}">
	<input type="hidden" name="keywords" value="${param.keywords}" />
	<input type="hidden" name="pageNum" value="1" />
	<input type="hidden" name="numPerPage" value="${page.numPerPage}" />
	<input type="hidden" name="field" value="fNo" />
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="/paper/teacher/teacher_findByFno" method="post">
	<div class="searchBar">
		...
		<table class="searchContent">
			<tr>
				...
				<td>
					要查询的值：<input type="text" name="value" />
				</td>
			</tr>
		</table>
		<div class="subBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="student_add2.jsp" target="navTab"><span>添加</span></a></li>
			<li><a class="delete" href="/paper/stu/student_deletestu?fno={sid_user}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="/paper/stu/student_findstu?fno={sid_user}" target="navTab"><span>修改</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		<thead>
			<tr>
				...
				<th width="100" align="center">方向</th>
				<th width="100" align="center">辅导员姓名</th>
				<th width="100" align="center">辅导员工号</th>
				<th width="100" align="center">电话</th>
				<th width="100" align="center">邮箱</th>
				<th width="100" align="center">QQ</th>
				<th width="80" align="center">实习单位</th>
				<th width="80" align="center">工作单位</th>
				<th width="50" align="center">状态</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach var="c" items="${stulist }">
