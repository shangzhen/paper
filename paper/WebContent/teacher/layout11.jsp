...
<body>
<form id="pagerForm" method="post" action="/paper/teacher/ShowStuList1">
	...
	　      <table class="table" width="100%" layoutH="138">
			...
			<%-- name= <%=session.getAttribute("name") %> --%>
				...
				<tr>
					...
					<td><s:property value="#student.ftitle"/></td>
					<td><s:property value="#student.fcommentstate"/>&nbsp;&nbsp;<s:property value="#student.fcommentScoreSum"/></td>
					<td>
						<a  href="downloadfile?downloadfile=<s:property value="#student.fno" />" target="ajaxTodo" title="确定要下载吗?"><span><b>下载</b></span></a>
						
						<a  href="pingding1.jsp?sno=<s:property value="#student.fno"/>&&
								...
								sftitle=<s:property value="#student.ftitle"/>" target="dialog" mask="true" title="成绩评定" width="700" height="580"><span><b>评阅老师评定</b></span></a>
						<a  href="pingyu2?sno=<s:property value="#student.fno"/>"
