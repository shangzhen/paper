...
<body>
<form id="pagerForm" method="post" action="/paper/teacher/ShowStuList">
			...
			<%-- name= <%=session.getAttribute("name") %> --%>
				...
				<tr>
					...
					<td>
						...
						<a  href="pingding.jsp?sno=<s:property value="#student.fno"/>&&
								...
								sftitle=<s:property value="#student.ftitle"/>"
								 target="dialog" mask="true" title="成绩评定"  width="600" height="580"><span><b>指导老师评定</b></span></a>
						<a  href="pingyu1?sno=<s:property value="#student.fno"/>"
								 target="dialog" mask="true" title="指导老师评语"  width="600" height="300"><span><b>评语</b></span></a>		 
