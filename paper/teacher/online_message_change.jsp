...
<title>修改已回复的咨询信息</title>

</head>
<body>
<div class="pageContent">
	<form method="post" action="/paper/teacher/noticeInformation_changeMessage" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)">
		...
		<input type="hidden" name="online.fqueryTime" value="${online.fqueryTime }">
			...
			<dl>
				<dt>回复内容：</dt>
				<dd><textarea name="rContents" cols="50" rows="4" maxlength="500">${online.freply }</textarea></dd>
			</dl>
