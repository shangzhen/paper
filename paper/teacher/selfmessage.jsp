	...
	<div class="pageContent">
		<div class="pageFormContent nowrap" layoutH="97">
			<dl>
				<dt>工号：</dt>
				<dd>
					<input type="text" name="tc.ftid" class="number" value=<%= session.getAttribute("user")%> readonly="readonly"/>
				</dd>
			</dl>
			<dl>
				<dt>姓名：</dt>
				<dd>
					<input type="text" name="tc.fname" value="${teacher.fname }" class="required" maxlength="20" readonly="readonly"/>
				</dd>
			</dl>
